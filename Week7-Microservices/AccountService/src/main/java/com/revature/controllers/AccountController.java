...
public class AccountController {
	...
	public AccountController() {
		accounts.add(new Account(1,350.25,1));
		accounts.add(new Account(2,867.14,1));
		accounts.add(new Account(3,50.00,2));
		accounts.add(new Account(4,980.54,2));
		accounts.add(new Account(5,3500.25,3));
		accounts.add(new Account(6,4800.75,4));
		accounts.add(new Account(7,450.25,4));
	}
